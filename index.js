...
async function test(){
    ...
    let itemID = await UrlParse('https://www.tiktok.com/@mau_apaan/video/7139062231605595419?is_from_webapp=1&sender_device=pc&web_id=7129868894336697857')
    ...
    let data          = `item_id=${itemID}&play_delta=1`
        ...
        const res = await fetch(URI+data, {method: 'POST', headers:headers, agent: proxyAgent})
